...
Builder.load_file('views/student_edit_subjects_view.kv')

class StudentEditSubjectsView(Screen):
    ...
    def add_subject(self):
        print(f"Added for student: {self.user_obj.id} subject_id: {self.subject_id}")
        self.user_obj.update_subjects(self.user_obj.id, self.subject_id)
        self.populate_subjects()
        self.ids.search_box.text = ''

    def delete_subject(self, subject_id):
        self.user_obj.delete_student_subjects(self.user_obj.id, subject_id)
        print(f"Deleted for student: {self.user_obj.id} subject_id: {self.subject_id}")
        self.populate_subjects()
###
